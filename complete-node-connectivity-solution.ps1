#!/usr/bin/env pwsh
# Complete IPPAN Node Connectivity Solution
# This script provides multiple solutions for the node connectivity issue

Write-Host "IPPAN Node Connectivity - Complete Solution" -ForegroundColor Cyan
...
$server1Ports = @(22, 2222, 443, 80, 3389, 8080, 9000)
$openPorts = @()
...
if ($openPorts.Count -gt 0) {
    ...
    Write-Host "  Attempting alternative access methods..." -ForegroundColor Yellow
...
# Solution 2: Configure Server 2 as standalone with manual peer addition
