...
# Staged batch ingest at 50k TPS offered (20s then 60s).
#
# Required env:
...
run_stage() {
  ...
  # Proof hook: show /health responsiveness after a 50k stage (10 successive curls).
  echo "--- health burst (10) ---"
  health_burst_10
  echo "--- end health burst ---"
...
run_stage 50000 20 $((50000 * 20))
run_stage 50000 60 $((50000 * 60))
