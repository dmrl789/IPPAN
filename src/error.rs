...
impl From<rustls::Error> for IppanError {
    fn from(err: rustls::Error) -> Self {
        IppanError::Rustls(format!("{}", err))
    }
}

impl From<rustls::client::InvalidDnsNameError> for IppanError {
    fn from(err: rustls::client::InvalidDnsNameError) -> Self {
        IppanError::InvalidDnsName(format!("{}", err))
    }
}
