...
- Next.js app (Unified UI) uses env flags:
  `NEXT_PUBLIC_ENABLE_FULL_UI=1`, `NEXT_PUBLIC_GATEWAY_URL=https://api.ippan.org`,
  `NEXT_PUBLIC_API_BASE_URL=https://api.ippan.org`, `NEXT_PUBLIC_WS_URL=wss://api.ippan.org/ws`.
