...
fn sample_telemetry() -> Vec<TelemetryRecord> {
    vec![
        TelemetryRecord {
            ...
            latency_ms: Fixed::from_scaled_units(118, 2),
            uptime_pct: Fixed::from_scaled_units(9_992, 2),
            peer_entropy: Fixed::from_scaled_units(82, 2),
        },
        TelemetryRecord {
            node_id: "validator-beta".to_string(),
            local_time_us: 10_000_070,
            latency_ms: Fixed::from_scaled_units(145, 2),
            uptime_pct: Fixed::from_scaled_units(9_875, 2),
            peer_entropy: Fixed::from_scaled_units(76, 2),
        },
        TelemetryRecord {
            node_id: "validator-gamma".to_string(),
            local_time_us: 10_000_180,
            latency_ms: Fixed::from_scaled_units(97, 2),
            uptime_pct: Fixed::from_scaled_units(9_965, 2),
            peer_entropy: Fixed::from_scaled_units(88, 2),
        },
        TelemetryRecord {
            node_id: "validator-delta".to_string(),
            local_time_us: 10_000_010,
            latency_ms: Fixed::from_scaled_units(162, 2),
            uptime_pct: Fixed::from_scaled_units(9_795, 2),
            peer_entropy: Fixed::from_scaled_units(73, 2),
        },
    ]
}
