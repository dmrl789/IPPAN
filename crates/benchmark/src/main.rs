...
async fn benchmark_tps(cli: &Cli) -> Result<()> {
    ...
    println!("║ Total time:            {:>11.2}s ║", duration.as_secs_f64());
    println!("║ TPS:                   {:>14.2} ║", tps);
    println!("║ Avg latency:           {:>11.2}ms ║", duration.as_millis() as f64 / total_success as f64);
    println!("╚═══════════════════════════════════════╝");
...
async fn benchmark_latency(cli: &Cli) -> Result<()> {
    ...
    println!("║ Min:                   {:>11.2}ms ║", min_latency.as_secs_f64() * 1000.0);
    println!("║ Avg:                   {:>11.2}ms ║", avg_latency.as_secs_f64() * 1000.0);
    println!("║ Max:                   {:>11.2}ms ║", max_latency.as_secs_f64() * 1000.0);
    println!("║ P50 (median):          {:>11.2}ms ║", p50.as_secs_f64() * 1000.0);
    println!("║ P95:                   {:>11.2}ms ║", p95.as_secs_f64() * 1000.0);
    println!("║ P99:                   {:>11.2}ms ║", p99.as_secs_f64() * 1000.0);
    println!("╚═══════════════════════════════════════╝");
...
async fn benchmark_network(cli: &Cli) -> Result<()> {
    ...
    println!("╠═══════════════════════════════════════╣");
    println!("║ Response time:         {:>11.2}ms ║", duration.as_secs_f64() * 1000.0);
    println!("╚═══════════════════════════════════════╝");
    println!();
    println!("Peer data:");
...
async fn benchmark_storage(cli: &Cli) -> Result<()> {
    ...
    println!("║ Avg read time:         {:>11.2}ms ║", avg_read.as_secs_f64() * 1000.0);
    println!("║ P50 read time:         {:>11.2}ms ║", p50.as_secs_f64() * 1000.0);
    println!("║ P95 read time:         {:>11.2}ms ║", p95.as_secs_f64() * 1000.0);
