# Deploy IPPAN on Both Servers - Final Version
Import-Module Posh-SSH -ErrorAction SilentlyContinue

$SERVER1_IP = "188.245.97.41"
$SERVER2_IP = "135.181.145.174"
$SERVER1_PASSWORD = "7LuR4nUCfTiv"  # Server 1 rescue password
$SERVER2_PASSWORD = "VgRfqNg3T4sx"  # Server 2 rescue password

Write-Host "=== IPPAN Deployment on Both Servers ===" -ForegroundColor Cyan
Write-Host "Server 1: $SERVER1_IP (Password: $SERVER1_PASSWORD)" -ForegroundColor Blue
Write-Host "Server 2: $SERVER2_IP (Password: $SERVER2_PASSWORD)" -ForegroundColor Blue
Write-Host ""
...
# Deploy to Server 1
Deploy-IPPANOnServer -ServerIP $SERVER1_IP -ServerName "Server 1" -Username "root" -Password $SERVER1_PASSWORD -NodeID "node1"
...
# Deploy to Server 2
Deploy-IPPANOnServer -ServerIP $SERVER2_IP -ServerName "Server 2" -Username "root" -Password $SERVER2_PASSWORD -NodeID "node2"
