...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🚀 IPPAN Cross-Chain Demo");
    println!("========================\n");
    ...
    // Demo 1: Submit anchor from TestChain1
    println!("📌 Demo 1: Submitting anchor from TestChain1");
    ...
    // Demo 2: Submit anchor from StarkNet
    println!("📌 Demo 2: Submitting anchor from StarkNet");
    let anchor_tx = AnchorTx {
    ...
    // Demo 3: Get latest anchors
    println!("📌 Demo 3: Getting latest anchors");
    ...
    // Demo 4: Register bridge endpoints
    println!("📌 Demo 4: Registering bridge endpoints");
    ...
    // Demo 5: Verify inclusion proofs
    println!("📌 Demo 5: Verifying inclusion proofs");
    ...
    // Demo 6: Get light sync data
    println!("📌 Demo 6: Getting light sync data");
    ...
    println!("📌 Demo 7: Generating comprehensive report");
    ...
    println!("🎉 Cross-chain demo completed successfully!");
